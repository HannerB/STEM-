                        ...
                        <div class="card-body">
                                                    ...
                                                    <div id="JFuLS5wKJU15LFVK"
                                                        ...
                                                        <div id="kSP2OCMszidNrMrM"
                                                            ...
                                                            <p id="NBmH228k9Y4WIPV4"
                                                                ...
                                                                <span id="meJfvddcIzkkk03q" style="color:#000000;">{{ $user->name }}</span><br>
                                                            </p>
                                                        </div>
                                                    </div>
                                                </div>
                                                                    ...
                                                                    <foreignobject id="acLCUahOhXp0ZkSA" style="width:500px;height:499.998px;">
                                                                        <div id="w72cVcJT5Gz4q0ON"
                                                                            ...
                                                                            <div id="IG4ChFgAxRfKJTAF"
                                                                                ...
                                                                                @if ($user->url)
                                                                                    <img src="{{ $user->url }}" title="{{ $user->name }}" loading="lazy" style="transform: translate(-4.65969453px, 0px) rotate(0deg); display: block; object-fit: fill; width: 524.64115988px; transform-origin: 262.32057994px 393.48086991px; opacity: 1.0; height: 786.96173982px;">
                                                                                @else
                                                                                    <i class="material-icons" title="{{ $user->name }}" loading="lazy" style="font-size: 500px;">person</i>
                                                                                @endif
                                                                            </div>
                                                                        </div>
                                                    ...
                                                    <div id="oWKcACpk5olmvMef"
                                                        ...
                                                        <div id="QzNMH6qB800ouchQ" style="flex-direction:column;display:flex;width:100%;justify-content:flex-start;opacity:1.0;height:100%;">
                                                            <ul id="VWK7l5LufJKIUsw0">
                                                                @if ($user->role)
                                                                <li id="{{ $user->id }}" style="margin-left:1.7em;color:#000000;list-style-type:disc;font-family:YAFdSQYNjgw-0;line-height:1.4em;">
                                                                    <span>
                                                                        {{ $user->role->name }}
                                                                    </span>
                                                                @else
                            ...
                            <div class="card-footer">
                                <div class="card-footer ml-auto mr-auto">
                                    <a href="{{ route('users.index') }}"type="submit" class="btn btn-sm btn-danger">Volver</a>
                                </div>
                                <div class="card-footer ml-auto mr-auto">
