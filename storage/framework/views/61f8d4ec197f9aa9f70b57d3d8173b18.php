...
<head>
    ...
    <link href="<?php echo e(asset('dashboard/css/material-dashboard.css?v=2.1.1')); ?>" rel="stylesheet" />
    <link href="<?php echo e(asset('dashboard/css/material-kit.min.css?v=2.0.7')); ?>" rel="stylesheet" />
    <!-- head -->
</head>
...
<body class="off-canvas-sidebar">
                    ...
                    <div class="container" style="height: auto;">
                        <div class="row align-items-center">
                            <div class="col-lg-4 col-md-6 col-sm-8 ml-auto mr-auto">
                                <form class="form" method="POST" action="<?php echo e(route('CardsProfes')); ?>">
                                    <?php echo csrf_field(); ?>
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="bmd-form-group">
                                                <div class="input-group">
                                                    ...
                                                    <input type="text" name="email" class="form-control" placeholder="Nombre de usuario o Email..." value="<?php echo e(old('email')); ?>" required autocomplete="email" autofocus>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-check mr-auto ml-3 mt-3">
                                                <label class="form-check-label">
                                                    <input class="form-check-input" type="checkbox" name="remember" <?php echo e(old('remember') ? 'checked' : ''); ?>> Remember me
    ...
    <!-- script -->
    <script src="<?php echo e(asset('dashboard/js/core/jquery.min.js')); ?>"></script>
    <script src="<?php echo e(asset('dashboard/js/core/popper.min.js')); ?>"></script>
    <script src="<?php echo e(asset('dashboard/js/core/bootstrap-material-design.min.js')); ?>"></script>
    <script src="https://cdnjs.cloudflare.com/ajax/libs/dropzone/5.9.2/min/dropzone.min.js"></script>
    <!-- script -->
</body>

</html>
<?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/STEM--main/resources/views/entreprofes/loginEntre.blade.php ENDPATH**/ ?>