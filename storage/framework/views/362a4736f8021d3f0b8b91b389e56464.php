<figure class="main-banner type3">
    <div class="img">
        <img src="<?php echo e($news->url); ?>" class="img-responsive attachment-full size-full wp-post-image" alt="<?php echo e($news->slug); ?>" title="Cocineras de Barrio Abajo preparan su camino como empresarias del sector gastronómico" srcset="<?php echo e($news->url); ?> 2560w, <?php echo e($news->url); ?> 768w, <?php echo e($news->url); ?> 1920w, <?php echo e($news->url); ?> 1536w, <?php echo e($news->url); ?> 2048w" sizes="(max-width: 2560px) 100vw, 2560px" />
    </div><!-- end img -->
            ...
            <div class="col-lg-10 col-lg-offset-1">
                <div class="article-section type2">
                    <ol class="breadcrumb">
                        ...
                        <li><a href="<?php echo e(route('home.news')); ?>">Noticias</a></li>
                    </ol>
                    ...
                    <div class="date-bar">
                        <div class="row">
                            <div class="col-sm-8">
                                <time><span class="month">&nbsp;<?php echo e(\Carbon\Carbon::parse($news->date_of_the_new_story)->translatedFormat('l, j \d\e F \d\e Y H:i')); ?></span>
                            </div>
